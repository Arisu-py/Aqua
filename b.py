...
def game_over(x):
    ...
    pygame.time.set_timer(TOTAL, 5000)
    ...
    while running:
        ...
        draw_text(screen, str(x), 40, 30, 10)
        pygame.display.flip()
    pygame.quit()
...
def game():
    ...
    while running:
        if game_over:
            ...
            pygame.time.set_timer(Fugu_POW, 10000)
            # random.randint(45000, 75000)
            ...
            pygame.time.set_timer(GREENPERL, 10000)
            # random.randint(55000, 110000)

            SHARK = pygame.USEREVENT + 14
            pygame.time.set_timer(SHARK, 100000)
            random.randint(300000, 500000)
        ...
        all_sprites.update()
        all_sprites.draw(screen)
        draw_text(screen, str(player.live), 150, 30, 10)
        draw_text(screen, str(player.score), 40, 30, 10)
        if not player.live_f:
            print(1)
            draw_text(screen, str(player.k), 20, 200, 10)
        pygame.display.flip()
    pygame.quit()
    return player.score
